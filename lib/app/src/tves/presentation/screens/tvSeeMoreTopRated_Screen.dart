...
import '../../../moves/presentation/controllers/movies_event.dart';
import '../../../moves/presentation/controllers/movies_state.dart';
import '../../../moves/presentation/screens/movie_detail_screen.dart';

class TvSeeMoreTopRated extends StatefulWidget {
  const TvSeeMoreTopRated({Key? key}) : super(key: key);

  @override
  State<TvSeeMoreTopRated> createState() => _TvSeeMoreTopRatedState();
}

class _TvSeeMoreTopRatedState extends State<TvSeeMoreTopRated> {
  @override
  Widget build(BuildContext context) {
    return BlocProvider.value(
      value: getIt<TvBloc>()..add(const GetTopRatedTvEvent(pageNum: 1)),
        ...
        builder: (BuildContext context, state) {
          return Scaffold(
              ...
              body: AnimatedConditionalBuilder(
                  condition: state.tvTopRated != null,
                  builder: (context) {
                    return Column(
                      children: [
                        Expanded(
                          child: AnimationLimiter(
                            child: ListView.separated(
                              ...
                              itemCount: state.tvTopRated!.results.length,
                              itemBuilder: (BuildContext context, int index) {
                                final movie = state.tvTopRated!.results[index];
                                              ...
                                              SizedBox(
                                                ...
                                                child: ClipRRect(
                                                  ...
                                                  child: CachedNetworkImage(
                                                    imageUrl:
                                                        ApiConstance.imgeUrl(movie.backdropPath),
